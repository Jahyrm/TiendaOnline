    ...
    if ($http_response_header[0]=="HTTP/1.1 201 Created") {
        ...
        if ($http_response_header[0]=="HTTP/1.1 201 Created") {
            ...
            if ($http_response_header[0]=="HTTP/1.1 200 OK") {
                header("Location: ../../cuenta-usuario.php?m=19");
            } else {
                header("Location: ../../cuenta-usuario.php?m=20");
            }
        } else {
            header("Location: ../../cuenta-usuario.php?m=21");
        }
    } else {
        header("Location: ../../cuenta-usuario.php?m=22");
    }
} else {
    header("Location: ../../cuenta-usuario.php?m=23");
}
?>